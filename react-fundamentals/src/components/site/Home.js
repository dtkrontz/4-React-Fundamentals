        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>We have tried to collect the very best resources for this app, and we ahve cited those <Link to="/resources">here</Link>.</li>
                    <li>The set up for this app might be the most confusin part. Hang in there..</li>
