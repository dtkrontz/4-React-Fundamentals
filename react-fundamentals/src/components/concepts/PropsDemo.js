        ...
        <div className='main'>
            <div className='mainDiv'>
                <div style ={styles}>
                    ...
                    <FunctionalComponent string='will this display too? - Props are pretty cool right?' function={toggleBackgroundColor} selectedStyle={ backgroundColor } />
                    <FunctionalComponent string='will this display also? - You can send data from one component ...' function={toggleBorderRadius} selectedStyle={ borderRadius } />
                    <FunctionalComponent string='will this display at the bottom? - ... to another!' function={toggleBorderStyle} selectedStyle={ borderStyle } />
                </div>
            </div>
        </div>
    );
