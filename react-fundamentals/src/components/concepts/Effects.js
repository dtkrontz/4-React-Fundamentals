    ...
    return (
        <div className="main">
            <div className='mainDiv'>
                ...
                <ul>
                    <li>They are triggered with state and prop updated, as well as after initial render to the DOM.</li>
...
const SampleEffect = () => {
    ...
    // Build a useEffect function which will console.log() some message to the screen
    useEffect(() => {
            console.log('Some message to the screen');
    }, [timerRunning])

    // Module Solution to - Build a useEffect function which will console.log() some message to the screen
    // useEffect(() => {
